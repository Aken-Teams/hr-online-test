      ...
      data: {
        ...
        result: session.result
          ? {
              ...
              practicalScore: session.result.practicalScore,
              combinedScore: session.result.combinedScore,
            }
          : null,
        passScore: session.exam.passScore,
        theoryWeight: session.exam.theoryWeight,
        practicalWeight: session.exam.practicalWeight,
        compositePassScore: session.exam.compositePassScore,
        unansweredCount,
        pendingGradingCount,
        correctAnswers,
        wrongAnswers,
