    ...
    <div className="space-y-6">
      ...
      <Card title="Excel 文件导入">
        ...
        >
          ...
          <p className="mt-1 text-xs text-gray-500">支持 .xls 和 .xlsx 格式</p>
          <input
            ref={fileInputRef}
            type="file"
            accept=".xls,.xlsx"
        ...
        {uploading && (
          <div className="mt-4">
            <p className="text-sm text-gray-500 mb-2">解析中...</p>
        ...
        <Card title="导入结果">
          <div className="space-y-3">
            <div className="flex items-center gap-6">
              <div>
                <span className="text-sm text-gray-500">成功导入：</span>
              ...
              {importResult.failed > 0 && (
                <div>
                  <span className="text-sm text-gray-500">导入失败：</span>
        ...
        <div className="space-y-4">
          ...
          {photoFiles.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {photoFiles.slice(0, 20).map((f, i) => (
                <div
                  key={i}
                  className="flex items-center gap-1.5 rounded-lg bg-gray-50 px-2.5 py-1 text-xs text-gray-600"
                >
              ...
              {photoFiles.length > 20 && (
                <span className="text-xs text-gray-400">...等 {photoFiles.length - 20} 个文件</span>
              )}
            </div>
          )}
          ...
          {photoUploading && (
            <div>
              ...
              <Progress value={photoProgress} color="indigo" />
            </div>
          )}
