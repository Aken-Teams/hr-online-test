      ...
      {results.length === 0 ? (
        ...
        <>
          ...
          <div className="space-y-3 sm:hidden">
            {results.map((r) => (
              <div key={r.sessionId} className="rounded-xl border border-stone-200 bg-white p-4 shadow-sm">
          ...
          <Card className="hidden sm:block">
            <div className="overflow-x-auto">
              <table className="w-full text-sm table-fixed">
                ...
                <tbody>
                  {results.map((r) => (
                    <tr key={r.sessionId} className="border-b border-stone-50">
                      <td className="py-2.5 pr-3 font-medium text-stone-800 truncate">{r.examTitle}</td>
